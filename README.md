...
preprocess_before_annotation.py handles image cleaning and resizing before annotation. Embryo_YOLOv8_Training.ipynb is the training notebook built on Google Colab.
